...
import { MainFlow } from '@flows/some-flow-name'
import { ProfileFlow } from '@flows/some-flow-name/ui/pages/profile'
import { styled } from '@shared/ui/theme'
import { useTheme } from '@shared/hooks'
import { ATMsFlow } from '@flows/some-flow-name/ui/pages/ATMs'
